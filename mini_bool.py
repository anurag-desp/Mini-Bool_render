...
def takeInput():
    ...
    with input_area:
        ...
        st.markdown(
            ...
            </span><span style="color:#C39BD3"><br>Please bear in mind that, for a given expression, there can be multiple solutions, and the solution generated
            by the program might not always match with the predicted solution that you might have in mind :)</span></span>''', unsafe_allow_html=True
        )
        st.markdown("___")
...
if __name__ == "__main__":
    ...
    st.set_page_config(
        ...
        page_icon = "animations/mini_bool_icon.png",
        layout = "wide"
    )

    # CGU image
    image = Image.open('animations/cgu_logo.png')
